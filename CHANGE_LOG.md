...
* 2021-0626: 2.3.0.3 (Lisias) for KSP >= 1.2
	...
	+ Promotes to RELEASE
	+ Closes issues:
		- [#15](https://github.com/net-lisias-ksp/KSPAPIExtensions/issues/15) Ensure this is working fine on KSP 1.12.x		- [#14](https://github.com/net-lisias-ksp/KSPAPIExtensions/issues/14) The installment check is terribly naive
