...
{
	internal class X86 : Ifc
	{
		internal X86()
		{
			Util.SystemTools.Assembly.LoadAndStartup("InputInterface.x86"); // TODO: FIX ME! How to load native DLLs?
		}
		...
		[DllImport("XInputInterface.x86", EntryPoint = "XInputGamePadGetState")]
		private static extern uint dll_XInputGamePadGetState(uint playerIndex, out GamePadState.RawState state);

		[DllImport("XInputInterface.x86", CallingConvention = CallingConvention.Cdecl, EntryPoint = "XInputGamePadSetState")]
