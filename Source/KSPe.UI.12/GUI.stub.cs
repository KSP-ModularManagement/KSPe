...
namespace KSPe.UI
{
	...
	{
		public static Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, string text)						{ return UnityEngine.GUI.Window(id, clientRect, func, text); }
		public static Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, Texture image)						{ return UnityEngine.GUI.Window(id, clientRect, func, image); }
		public static Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, GUIContent content)					{ return UnityEngine.GUI.Window(id, clientRect, func, content); }
		public static Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, string text, GUIStyle style)		{ return UnityEngine.GUI.Window(id, clientRect, func, text, style); }
		public static Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, Texture image, GUIStyle style)		{ return UnityEngine.GUI.Window(id, clientRect, func, image, style); }
		public static Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, GUIContent title, GUIStyle style)	{ return UnityEngine.GUI.Window(id, clientRect, func, title, style); }
