...
namespace KSPe.KSP12.UI
{
	...
	{
		public Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, string text) { return UnityEngine.GUI.Window(id, clientRect, func, text); }
		public Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, Texture image) { return UnityEngine.GUI.Window(id, clientRect, func, image); }
		public Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, GUIContent content) { return UnityEngine.GUI.Window(id, clientRect, func, content); }
		public Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, string text, GUIStyle style) { return UnityEngine.GUI.Window(id, clientRect, func, text, style); }
		public Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, Texture image, GUIStyle style) { return UnityEngine.GUI.Window(id, clientRect, func, image, style); }
		public Rect Window(int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, GUIContent title, GUIStyle style) { return UnityEngine.GUI.Window(id, clientRect, func, title, style); }
