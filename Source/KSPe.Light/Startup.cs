...
namespace KSPe
{
	...
	public class Startup:MonoBehaviour
	{
		...
		private void Start()
		{
			LOG.force("Version {0} for Goo Pumps & Oils' Speed Pump", Version.Text);
		}
		...
		private static readonly Util.Log.Logger LOG = Util.Log.Logger.CreateForType<Startup>("KSPe.Light.GPOSP", false, 0);
	}
}
