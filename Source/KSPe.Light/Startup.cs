...
namespace KSPe
{
	...
	public class Startup:MonoBehaviour
	{
		...
		private void Start()
		{
			LOG.force("Version {0} for Kerbal Aircraft Expansion /L", Version.Text);
		}
		...
		private static readonly Util.Log.Logger LOG = Util.Log.Logger.CreateForType<Startup>("KSPe.Light.KAX", false, 0);
	}
}
