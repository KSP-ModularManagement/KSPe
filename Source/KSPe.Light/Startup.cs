...
namespace KSPe
{
	...
	public class Startup:MonoBehaviour
	{
		...
		private void Start()
		{
			LOG.force("Version {0} for Kourageous Tourists /L", Version.Text);
		}
		...
		private static readonly Util.Log.Logger LOG = Util.Log.Logger.CreateForType<Startup>("KSPe.Light.KourageousTourists", false, 0);
	}
}
