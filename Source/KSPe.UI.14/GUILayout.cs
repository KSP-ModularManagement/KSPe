...
{ 
	...
	{
		public Rect Window (int id, Rect screenRect, UnityEngine.GUI.WindowFunction func, string text, params GUILayoutOption[] options)						{ return ClickThroughFix.ClickThruBlocker.GUILayoutWindow(id, screenRect, func, text, options); }
