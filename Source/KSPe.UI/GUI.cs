...
namespace KSPe.UI
{
	...
	{        
		...
		public static Rect Window (int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, string text)                       { return ClickThroughFix.ClickThruBlocker.GUIWindow(id, clientRect, func, text); }       
        public static Rect Window (int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, Texture image)                     { return ClickThroughFix.ClickThruBlocker.GUIWindow(id, clientRect, func, image); }       
		public static Rect Window (int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, GUIContent content)                { return ClickThroughFix.ClickThruBlocker.GUIWindow(id, clientRect, func, content); }
		public static Rect Window (int id, Rect clientRect, UnityEngine.GUI.WindowFunction func, string text, GUIStyle style)       { return ClickThroughFix.ClickThruBlocker.GUIWindow(id, clientRect, func, text, style); }       
